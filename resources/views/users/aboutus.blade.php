...
<head>
    ...
    <title>About Us - Your Ecommerce Website</title>
    <style>
        body {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <h1 class="text-center mt-5 mb-4">About Us</h1>
                <p class="text-center">Welcome to ekart, your one-stop destination for quality products and exceptional service.</p>
